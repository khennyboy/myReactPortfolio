...
const Header = () => {
  ...
  return (
    <div
      className="pt-[5rem]  h-full 
         flex flex-col justify-evenly items-center"
    >
      <div>
        <h1 className="text-center text-2xl mb-6 leading-7">
          Nice to meet you! I am Sheriff Abdullateef
        </h1>
        <p className="text-center mb-6 leading-tight ">
          Based in Nigeria, I&#39;m a front end web developer Passionate about
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            ...
            className="bg-normal-brand_600 text-normal-brand_50 w-[40%] 
